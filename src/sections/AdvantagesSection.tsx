...
export function AdvantagesSection() {
  return (
    <section id="cinematic" className="advantages-section relative flex h-[100dvh] min-h-[680px] items-center justify-center overflow-hidden">
      ...
      <motion.div className="advantages-copy relative z-10 w-full px-2 sm:px-4 md:px-4" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.35 }} transition={{ duration: 0.5 }}>
        <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-3 text-center sm:gap-4">

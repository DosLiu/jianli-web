...
export function AdvantagesSection() {
  return (
    <section id="cinematic" className="relative flex h-[100dvh] min-h-[680px] items-center justify-center overflow-hidden">
      ...
      <motion.div className="relative z-10 w-full px-2 sm:px-4 md:px-4" style={{ top: '-4cm' }} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.35 }} transition={{ duration: 0.5 }}>

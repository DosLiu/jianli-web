...
export function MethodsSection() {
  return (
    <section className="bg-black px-6 pb-16 pt-0 text-center">
      ...
      <motion.div className="mx-auto mt-12 flex max-w-md -translate-y-8 flex-col items-center gap-4 md:grid md:max-w-6xl md:grid-cols-3 md:items-stretch md:gap-6" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.4 }} transition={{ duration: 1.2, delay: 0.4 }}>
